...
import 'package:easy_download/screens/facebookDownload/facebookData.dart';
                    ...
                    : MyButton(
                        ...
                        onPressed: () async {
                          ...
                          if (connectivityResult == ConnectivityResult.none) {
                            _fbScaffoldKey.currentState!.showSnackBar(mySnackBar(context, 'No Internet') as SnackBar);
                            return;
                          }
                          setState(() {
                            _notfirst = true;
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: MyButton(
                                          ...
                                          onPressed: _hasAudio
                                              ? () async {
                                                  _fbScaffoldKey.currentState!.showSnackBar(mySnackBar(context, 'Added to Download') as SnackBar);
